...
Examples:
  mcp-studio remove my-server
  mcp-studio remove my-server --yes`,
...
func init() {
	...
	removeCmd.Flags().StringVarP(&removeConfigPath, "config", "c", "", "Path to config file (default: ~/.config/mcp-studio/config.json)")
